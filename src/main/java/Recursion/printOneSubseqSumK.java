...
public class printOneSubseqSumK {
    public static boolean findSubsequence(int curr, int n, int arr[], List<Integer> subarr, List<List<Integer>> res, int k, int currSum){
//Whole Idea is to take and not take array elements
        ...
        if (findSubsequence(curr+1,n,arr,subarr,res, k, currSum) == true){
            return true;
        }
    ...
    public static void main(String[] args) {
        ...
        findSubsequence(0,n, arr, subarr, res, k, currSum);
